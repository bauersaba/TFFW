...
{
    $result = array();
    $result[] = array('caption' => 'Dados', 'short_caption' => 'Dados', 'filename' => 'dados.php', 'name' => 'dados', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
...
{
    return
        '<p align="right">(C) <span><script type="text/javascript">document.write(new Date().getFullYear().toString())</script></span> Edson Lima & Marcelo Bauer</a>.</p>';
}
