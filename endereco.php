 ...
 */
    ...
    class enderecoPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Endereco');
            $this->SetMenuLabel('Endereco');
    ...
    try
    {
        $Page = new enderecoPage("endereco", "endereco.php", GetCurrentUserPermissionsForPage("endereco"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("endereco"));
